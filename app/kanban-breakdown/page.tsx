            ...
            <>
                ...
                <div className="mb-5">
                    ...
                    <Paragraph alignment="text-left">
                        This project is my web app implementation of a Kanban
                        board. It allows the user to organize their tasks for
                        different projects in 2 dimensions: vertically by
                        priority and horizontally by status.
                    </Paragraph>
                </div>
                <div className="mb-20">
                    <LabeledContainer
                ...
                <div className="flex flex-col gap-3 mb-20">
                    ...
                    <Paragraph alignment="text-left">
                        ...
                        one-to-many relationships: one user has many boards, one
                        board has many columns, etc.
                    </Paragraph>
                    <Image
                        className="my-10"
                        src={relationDiagram}
                    ...
                    />
                    <Paragraph alignment="text-left">
                        For this reason, I chose to use a PostgreSQL database as
                        it seemed to be a solid, well-known option as a
                        relational database.
                    </Paragraph>
                </div>
                ...
                <div className="flex flex-col gap-3 mb-20">
                    ...
                    <Paragraph alignment="text-left">
                        ...
                        requests to an API layer. In the API route handlers, I
                        used Prisma to retrieve the data from the db. The
                        abstraction of the data util functions creates a clear
                        separation between my app and the data that it uses,
                        mitigating the need for changes in my app if the API or
                        database changes.
                    </Paragraph>
                </div>
                    ...
                    <CodeHightlight title="Dynamic Inputs">
                        <>
                            ...
                            <Paragraph alignment="text-left">
                                ...
                                columns and subtasks provided an extra challenge
                                as multiple CRUD operations had to be performed
                                in a single request: add, edit, and delete.
                            </Paragraph>
                            <CroppedImage
                            ...
                            />
                            <Paragraph alignment="text-left">
                                To accomplish this, I used the data shape above.
                                An object with arrays for creation, updating,
                                and deletion. Depending on the action taken by
                                the user, multiple arrays could be updated, each
                            ...
                            <Paragraph alignment="text-left">
                                ...
                                “create” array is put through a map whose
                                behavior is governed by the length of the
                                “update” array because the “create” array always
                                appears at the bottom of the dynamic list. The
                                “update” array is mapped in the typical way for
                                a change handler. Finally, the “delete” array is
                                simply spread out with no mapping since it is
                                never rendered (but it is sent to database for
                                the deletion of the appropriate items!)
                            </Paragraph>
                        </>
                    </CodeHightlight>
                </div>
                ...
                <div className="flex flex-col gap-5 mb-20">
                    ...
                    <Paragraph alignment="text-left">
                        ...
                        Next.js projects and Github as the OAuth provider. When
                        a new user signs in, a new UUID is created in User table
                        of the database and is associated with the user&apos;s
                        email. On subsequent logins, the email is found in the
                        database and the user is redirected to their boards. The
                        UUID for the user can seen in the URL.
                    </Paragraph>
                    <CroppedImage
                ...
                <div className="flex flex-col gap-5 mb-32">
                    ...
                    <Paragraph alignment="text-left">
                        ...
                        dropping of tasks. This was mostly due preferring the
                        API over those of other React drag and drop options and
                        the customization available with dndkit. To provide a
                        better user experience and maintain data integrity, task
                        grouping and ordering data is updated in the local cache
                        (using TanStack Query) during dragging and is only
                        synced to the database when the user finishes dragging.
                        In the event of an error, tasks are rolled back to their
                        ...
                        seemed like it would&apos;ve added a lot of complexity
                        and dev time so I decided to go with the simpler
                        solution.
                    </Paragraph>
                </div>
